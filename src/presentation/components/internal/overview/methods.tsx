    ...
    <Box component="section" className="w-full px-6 mt-5">
      ...
      >
        ...
        <Typography variant="body2" component="ul" className="my-1 text-left">
          <li>
            Simplicity in implementation because it uses basic mathematical operations that are easy
          ...
          <li>
            Provides calculation results based on weights to help produce more accurate and optimal
            decisions.
          </li>
          <li>
