  ...
  return (
    <Box component="section" className="w-full px-6 mt-5">
      ...
      >
        ...
        <Typography variant="body2" component="ol" className="my-1 text-left">
          <li>
          ...
          <li>Press the pencil icon and fill in the weight for each criterion, then press save.</li>
          <li>
          ...
          <li>There are conclusions from the calculation result, based on the highest V-Vector.</li>
        </Typography>
      </Container>
    </Box>
  );
